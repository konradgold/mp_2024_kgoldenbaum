...
cache_path = os.environ.get("CACHE_PATH_IMAGEBIND", "/hpi/fs00/home/konrad.goldenbaum/emb_cache/")
...
wandb.config.update({"model": "imagebind", "dataset": "ucf_crimes", "method": "gaussian"})
if wandb.run is not None:   
    wandb.run.name = "imagebind_ucf_crimes"


embedder = ImageBindEmbedders()
